...
--
-- Name: category_insert_function(); Type: FUNCTION; Schema: legacy; Owner: -
--

CREATE FUNCTION legacy.category_insert_function() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
        BEGIN
...
--
-- Name: ids_for_org(character varying); Type: FUNCTION; Schema: legacy; Owner: -
--

CREATE FUNCTION legacy.ids_for_org(character varying) RETURNS TABLE(nct_id character varying)
    LANGUAGE sql
    AS $_$
      SELECT DISTINCT nct_id FROM responsible_parties WHERE lower(affiliation) like lower($1)
      UNION
...
--
-- Name: ids_for_term(character varying); Type: FUNCTION; Schema: legacy; Owner: -
--

CREATE FUNCTION legacy.ids_for_term(character varying) RETURNS TABLE(nct_id character varying)
    LANGUAGE sql
    AS $_$
        SELECT DISTINCT nct_id FROM browse_conditions WHERE downcase_mesh_term like lower($1)
        UNION
...
--
-- Name: study_summaries_for_condition(character varying); Type: FUNCTION; Schema: legacy; Owner: -
--

CREATE FUNCTION legacy.study_summaries_for_condition(character varying) RETURNS TABLE(nct_id character varying, title text, recruitment character varying, were_results_reported boolean, conditions text, interventions text, gender character varying, age text, phase character varying, enrollment integer, study_type character varying, sponsors text, other_ids text, study_first_submitted_date date, start_date date, completion_month_year character varying, last_update_submitted_date date, verification_month_year character varying, results_first_submitted_date date, acronym character varying, primary_completion_month_year character varying, outcome_measures text, disposition_first_submitted_date date, allocation character varying, intervention_model character varying, observational_model character varying, primary_purpose character varying, time_perspective character varying, masking character varying, masking_description text, intervention_model_description text, subject_masked boolean, caregiver_masked boolean, investigator_masked boolean, outcomes_assessor_masked boolean, number_of_facilities integer)
    LANGUAGE sql
    AS $_$
      SELECT DISTINCT s.nct_id,
          s.brief_title,
...
--
-- Name: browse_conditions; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.browse_conditions (
    id integer NOT NULL,
    nct_id character varying,
    mesh_term character varying,
    downcase_mesh_term character varying,
...
--
-- Name: all_browse_conditions; Type: VIEW; Schema: legacy; Owner: -
--

CREATE VIEW legacy.all_browse_conditions AS
 SELECT browse_conditions.nct_id,
    array_to_string(array_agg(DISTINCT browse_conditions.mesh_term), '|'::text) AS names
   FROM legacy.browse_conditions
  GROUP BY browse_conditions.nct_id;


--
-- Name: browse_interventions; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.browse_interventions (
    id integer NOT NULL,
    nct_id character varying,
    mesh_term character varying,
    downcase_mesh_term character varying,
...
--
-- Name: all_browse_interventions; Type: VIEW; Schema: legacy; Owner: -
--

CREATE VIEW legacy.all_browse_interventions AS
 SELECT browse_interventions.nct_id,
    array_to_string(array_agg(browse_interventions.mesh_term), '|'::text) AS names
   FROM legacy.browse_interventions
  GROUP BY browse_interventions.nct_id;


--
-- Name: facilities; Type: TABLE; Schema: legacy; Owner: -
--
...
--
-- Name: all_cities; Type: VIEW; Schema: legacy; Owner: -
--

CREATE VIEW legacy.all_cities AS
 SELECT facilities.nct_id,
    array_to_string(array_agg(DISTINCT facilities.city), '|'::text) AS names
...
--
-- Name: conditions; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.conditions (
    id integer NOT NULL,
    nct_id character varying,
    name character varying,
    downcase_name character varying
...
--
-- Name: all_conditions; Type: VIEW; Schema: legacy; Owner: -
--

CREATE VIEW legacy.all_conditions AS
 SELECT conditions.nct_id,
    array_to_string(array_agg(DISTINCT conditions.name), '|'::text) AS names
...
--
-- Name: countries; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.countries (
    id integer NOT NULL,
    nct_id character varying,
    name character varying,
    removed boolean
...
--
-- Name: all_countries; Type: VIEW; Schema: legacy; Owner: -
--

CREATE VIEW legacy.all_countries AS
 SELECT countries.nct_id,
    array_to_string(array_agg(DISTINCT countries.name), '|'::text) AS names
   FROM legacy.countries
  WHERE (countries.removed IS NOT TRUE)
  GROUP BY countries.nct_id;


--
-- Name: design_outcomes; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.design_outcomes (
    id integer NOT NULL,
    nct_id character varying,
    outcome_type character varying,
    measure text,
...
--
-- Name: all_design_outcomes; Type: VIEW; Schema: legacy; Owner: -
--

CREATE VIEW legacy.all_design_outcomes AS
 SELECT design_outcomes.nct_id,
    array_to_string(array_agg(DISTINCT design_outcomes.measure), '|'::text) AS names
   FROM legacy.design_outcomes
  GROUP BY design_outcomes.nct_id;


--
-- Name: all_facilities; Type: VIEW; Schema: legacy; Owner: -
--

CREATE VIEW legacy.all_facilities AS
 SELECT facilities.nct_id,
    array_to_string(array_agg(facilities.name), '|'::text) AS names
   FROM legacy.facilities
  GROUP BY facilities.nct_id;
...
--
-- Name: design_groups; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.design_groups (
    id integer NOT NULL,
    nct_id character varying,
    group_type character varying,
    title character varying,
...
--
-- Name: all_group_types; Type: VIEW; Schema: legacy; Owner: -
--

CREATE VIEW legacy.all_group_types AS
 SELECT design_groups.nct_id,
    array_to_string(array_agg(DISTINCT design_groups.group_type), '|'::text) AS names
   FROM legacy.design_groups
  GROUP BY design_groups.nct_id;


--
-- Name: id_information; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.id_information (
    id integer NOT NULL,
    nct_id character varying,
    id_source character varying,
    id_value character varying,
...
--
-- Name: all_id_information; Type: VIEW; Schema: legacy; Owner: -
--

CREATE VIEW legacy.all_id_information AS
 SELECT id_information.nct_id,
    array_to_string(array_agg(DISTINCT id_information.id_value), '|'::text) AS names
   FROM legacy.id_information
  GROUP BY id_information.nct_id;


--
-- Name: interventions; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.interventions (
    id integer NOT NULL,
    nct_id character varying,
    intervention_type character varying,
    name character varying,
...
--
-- Name: all_intervention_types; Type: VIEW; Schema: legacy; Owner: -
--

CREATE VIEW legacy.all_intervention_types AS
 SELECT interventions.nct_id,
    array_to_string(array_agg(interventions.intervention_type), '|'::text) AS names
   FROM legacy.interventions
  GROUP BY interventions.nct_id;


--
-- Name: all_interventions; Type: VIEW; Schema: legacy; Owner: -
--

CREATE VIEW legacy.all_interventions AS
 SELECT interventions.nct_id,
    array_to_string(array_agg(interventions.name), '|'::text) AS names
   FROM legacy.interventions
  GROUP BY interventions.nct_id;
...
--
-- Name: keywords; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.keywords (
    id integer NOT NULL,
    nct_id character varying,
    name character varying,
    downcase_name character varying
...
--
-- Name: all_keywords; Type: VIEW; Schema: legacy; Owner: -
--

CREATE VIEW legacy.all_keywords AS
 SELECT keywords.nct_id,
    array_to_string(array_agg(DISTINCT keywords.name), '|'::text) AS names
...
--
-- Name: overall_officials; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.overall_officials (
    id integer NOT NULL,
    nct_id character varying,
    role character varying,
    name character varying,
...
--
-- Name: all_overall_official_affiliations; Type: VIEW; Schema: legacy; Owner: -
--

CREATE VIEW legacy.all_overall_official_affiliations AS
 SELECT overall_officials.nct_id,
    array_to_string(array_agg(overall_officials.affiliation), '|'::text) AS names
   FROM legacy.overall_officials
  GROUP BY overall_officials.nct_id;


--
-- Name: all_overall_officials; Type: VIEW; Schema: legacy; Owner: -
--

CREATE VIEW legacy.all_overall_officials AS
 SELECT overall_officials.nct_id,
    array_to_string(array_agg(overall_officials.name), '|'::text) AS names
   FROM legacy.overall_officials
  GROUP BY overall_officials.nct_id;
...
--
-- Name: all_primary_outcome_measures; Type: VIEW; Schema: legacy; Owner: -
--

CREATE VIEW legacy.all_primary_outcome_measures AS
 SELECT design_outcomes.nct_id,
    array_to_string(array_agg(DISTINCT design_outcomes.measure), '|'::text) AS names
   FROM legacy.design_outcomes
  WHERE ((design_outcomes.outcome_type)::text = 'primary'::text)
...
--
-- Name: all_secondary_outcome_measures; Type: VIEW; Schema: legacy; Owner: -
--

CREATE VIEW legacy.all_secondary_outcome_measures AS
 SELECT design_outcomes.nct_id,
    array_to_string(array_agg(DISTINCT design_outcomes.measure), '|'::text) AS names
   FROM legacy.design_outcomes
  WHERE ((design_outcomes.outcome_type)::text = 'secondary'::text)
...
--
-- Name: sponsors; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.sponsors (
    id integer NOT NULL,
    nct_id character varying,
    agency_class character varying,
    lead_or_collaborator character varying,
...
--
-- Name: all_sponsors; Type: VIEW; Schema: legacy; Owner: -
--

CREATE VIEW legacy.all_sponsors AS
 SELECT sponsors.nct_id,
    array_to_string(array_agg(DISTINCT sponsors.name), '|'::text) AS names
   FROM legacy.sponsors
  GROUP BY sponsors.nct_id;


--
-- Name: all_states; Type: VIEW; Schema: legacy; Owner: -
--

CREATE VIEW legacy.all_states AS
 SELECT facilities.nct_id,
    array_to_string(array_agg(DISTINCT facilities.state), '|'::text) AS names
   FROM legacy.facilities
  GROUP BY facilities.nct_id;
...
--
-- Name: baseline_counts; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.baseline_counts (
    id integer NOT NULL,
    nct_id character varying,
    result_group_id integer,
    ctgov_group_code character varying,
...
--
-- Name: baseline_counts_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.baseline_counts_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: baseline_counts_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.baseline_counts_id_seq OWNED BY legacy.baseline_counts.id;


--
-- Name: baseline_measurements; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.baseline_measurements (
    id integer NOT NULL,
    nct_id character varying,
    result_group_id integer,
    ctgov_group_code character varying,
...
--
-- Name: baseline_measurements_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.baseline_measurements_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: baseline_measurements_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.baseline_measurements_id_seq OWNED BY legacy.baseline_measurements.id;


--
-- Name: brief_summaries; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.brief_summaries (
    id integer NOT NULL,
    nct_id character varying,
    description text
);
...
--
-- Name: brief_summaries_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.brief_summaries_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: brief_summaries_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.brief_summaries_id_seq OWNED BY legacy.brief_summaries.id;


--
-- Name: browse_conditions_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.browse_conditions_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: browse_conditions_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.browse_conditions_id_seq OWNED BY legacy.browse_conditions.id;


--
-- Name: browse_interventions_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.browse_interventions_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: browse_interventions_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.browse_interventions_id_seq OWNED BY legacy.browse_interventions.id;


--
-- Name: calculated_values; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.calculated_values (
    id integer NOT NULL,
    nct_id character varying,
    number_of_facilities integer,
    number_of_nsae_subjects integer,
...
--
-- Name: calculated_values_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.calculated_values_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: calculated_values_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.calculated_values_id_seq OWNED BY legacy.calculated_values.id;


--
-- Name: search_results; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.search_results (
    id integer NOT NULL,
    nct_id character varying NOT NULL,
    name character varying NOT NULL,
    created_at timestamp without time zone NOT NULL,
...
--
-- Name: categories; Type: VIEW; Schema: legacy; Owner: -
--

CREATE VIEW legacy.categories AS
 SELECT search_results.id,
    search_results.nct_id,
    search_results.name,
    search_results.created_at,
    ...
    search_results."grouping",
    search_results.study_search_id
   FROM legacy.search_results;


--
-- Name: categories_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.categories_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: central_contacts; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.central_contacts (
    id integer NOT NULL,
    nct_id character varying,
    contact_type character varying,
    name character varying,
...
--
-- Name: central_contacts_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.central_contacts_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: central_contacts_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.central_contacts_id_seq OWNED BY legacy.central_contacts.id;


--
-- Name: conditions_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.conditions_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: conditions_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.conditions_id_seq OWNED BY legacy.conditions.id;


--
-- Name: countries_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.countries_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: countries_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.countries_id_seq OWNED BY legacy.countries.id;


--
-- Name: designs; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.designs (
    id integer NOT NULL,
    nct_id character varying,
    allocation character varying,
    intervention_model character varying,
...
--
-- Name: detailed_descriptions; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.detailed_descriptions (
    id integer NOT NULL,
    nct_id character varying,
    description text
);
...
--
-- Name: eligibilities; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.eligibilities (
    id integer NOT NULL,
    nct_id character varying,
    sampling_method character varying,
    gender character varying,
...
--
-- Name: covid_19_studies; Type: VIEW; Schema: legacy; Owner: -
--

CREATE VIEW legacy.covid_19_studies AS
 SELECT s.nct_id,
    s.overall_status,
    s.study_type,
    s.official_title,
   ...
   FROM (((((((((((ctgov.studies s
     FULL JOIN legacy.all_conditions ac ON (((s.nct_id)::text = (ac.nct_id)::text)))
     FULL JOIN legacy.all_id_information aid ON (((s.nct_id)::text = (aid.nct_id)::text)))
     FULL JOIN legacy.all_design_outcomes ado ON (((s.nct_id)::text = (ado.nct_id)::text)))
     FULL JOIN legacy.all_keywords ak ON (((s.nct_id)::text = (ak.nct_id)::text)))
     FULL JOIN legacy.all_interventions ai ON (((s.nct_id)::text = (ai.nct_id)::text)))
     FULL JOIN legacy.sponsors sp ON (((s.nct_id)::text = (sp.nct_id)::text)))
     FULL JOIN legacy.calculated_values cv ON (((s.nct_id)::text = (cv.nct_id)::text)))
     FULL JOIN legacy.designs d ON (((s.nct_id)::text = (d.nct_id)::text)))
     FULL JOIN legacy.eligibilities e ON (((s.nct_id)::text = (e.nct_id)::text)))
     FULL JOIN legacy.brief_summaries bs ON (((s.nct_id)::text = (bs.nct_id)::text)))
     FULL JOIN legacy.detailed_descriptions dd ON (((s.nct_id)::text = (dd.nct_id)::text)))
...
--
-- Name: design_group_interventions; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.design_group_interventions (
    id integer NOT NULL,
    nct_id character varying,
    design_group_id integer,
    intervention_id integer
...
--
-- Name: design_group_interventions_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.design_group_interventions_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: design_group_interventions_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.design_group_interventions_id_seq OWNED BY legacy.design_group_interventions.id;


--
-- Name: design_groups_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.design_groups_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: design_groups_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.design_groups_id_seq OWNED BY legacy.design_groups.id;


--
-- Name: design_outcomes_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.design_outcomes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: design_outcomes_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.design_outcomes_id_seq OWNED BY legacy.design_outcomes.id;


--
-- Name: designs_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.designs_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: designs_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.designs_id_seq OWNED BY legacy.designs.id;


--
-- Name: detailed_descriptions_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.detailed_descriptions_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: detailed_descriptions_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.detailed_descriptions_id_seq OWNED BY legacy.detailed_descriptions.id;


--
-- Name: documents; Type: TABLE; Schema: legacy; Owner: -
--
...
--
-- Name: documents_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.documents_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: documents_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.documents_id_seq OWNED BY legacy.documents.id;


--
-- Name: drop_withdrawals; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.drop_withdrawals (
    id integer NOT NULL,
    nct_id character varying,
    result_group_id integer,
    ctgov_group_code character varying,
...
--
-- Name: drop_withdrawals_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.drop_withdrawals_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: drop_withdrawals_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.drop_withdrawals_id_seq OWNED BY legacy.drop_withdrawals.id;


--
-- Name: eligibilities_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.eligibilities_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: eligibilities_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.eligibilities_id_seq OWNED BY legacy.eligibilities.id;


--
-- Name: facilities_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.facilities_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: facilities_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.facilities_id_seq OWNED BY legacy.facilities.id;


--
-- Name: facility_contacts; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.facility_contacts (
    id integer NOT NULL,
    nct_id character varying,
    facility_id integer,
    contact_type character varying,
...
--
-- Name: facility_contacts_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.facility_contacts_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: facility_contacts_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.facility_contacts_id_seq OWNED BY legacy.facility_contacts.id;


--
-- Name: facility_investigators; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.facility_investigators (
    id integer NOT NULL,
    nct_id character varying,
    facility_id integer,
    role character varying,
...
--
-- Name: facility_investigators_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.facility_investigators_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: facility_investigators_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.facility_investigators_id_seq OWNED BY legacy.facility_investigators.id;


--
-- Name: id_information_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.id_information_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: id_information_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.id_information_id_seq OWNED BY legacy.id_information.id;


--
-- Name: intervention_other_names; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.intervention_other_names (
    id integer NOT NULL,
    nct_id character varying,
    intervention_id integer,
    name character varying
...
--
-- Name: intervention_other_names_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.intervention_other_names_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: intervention_other_names_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.intervention_other_names_id_seq OWNED BY legacy.intervention_other_names.id;


--
-- Name: interventions_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.interventions_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: interventions_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.interventions_id_seq OWNED BY legacy.interventions.id;


--
-- Name: ipd_information_types; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.ipd_information_types (
    id integer NOT NULL,
    nct_id character varying,
    name character varying
);
...
--
-- Name: ipd_information_types_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.ipd_information_types_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: ipd_information_types_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.ipd_information_types_id_seq OWNED BY legacy.ipd_information_types.id;


--
-- Name: keywords_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.keywords_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: keywords_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.keywords_id_seq OWNED BY legacy.keywords.id;


--
-- Name: links; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.links (
    id integer NOT NULL,
    nct_id character varying,
    url character varying,
    description text
...
--
-- Name: links_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.links_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: links_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.links_id_seq OWNED BY legacy.links.id;


--
-- Name: mesh_headings; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.mesh_headings (
    id integer NOT NULL,
    qualifier character varying,
    heading character varying,
    subcategory character varying
...
--
-- Name: mesh_headings_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.mesh_headings_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: mesh_headings_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.mesh_headings_id_seq OWNED BY legacy.mesh_headings.id;


--
-- Name: mesh_terms; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.mesh_terms (
    id integer NOT NULL,
    qualifier character varying,
    tree_number character varying,
    description character varying,
...
--
-- Name: mesh_terms_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.mesh_terms_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: mesh_terms_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.mesh_terms_id_seq OWNED BY legacy.mesh_terms.id;


--
-- Name: milestones; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.milestones (
    id integer NOT NULL,
    nct_id character varying,
    result_group_id integer,
    ctgov_group_code character varying,
...
--
-- Name: milestones_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.milestones_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: milestones_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.milestones_id_seq OWNED BY legacy.milestones.id;


--
-- Name: outcome_analyses; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.outcome_analyses (
    id integer NOT NULL,
    nct_id character varying,
    outcome_id integer,
    non_inferiority_type character varying,
...
--
-- Name: outcome_analyses_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.outcome_analyses_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: outcome_analyses_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.outcome_analyses_id_seq OWNED BY legacy.outcome_analyses.id;


--
-- Name: outcome_analysis_groups; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.outcome_analysis_groups (
    id integer NOT NULL,
    nct_id character varying,
    outcome_analysis_id integer,
    result_group_id integer,
...
--
-- Name: outcome_analysis_groups_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.outcome_analysis_groups_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: outcome_analysis_groups_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.outcome_analysis_groups_id_seq OWNED BY legacy.outcome_analysis_groups.id;


--
-- Name: outcome_counts; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.outcome_counts (
    id integer NOT NULL,
    nct_id character varying,
    outcome_id integer,
    result_group_id integer,
...
--
-- Name: outcome_counts_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.outcome_counts_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: outcome_counts_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.outcome_counts_id_seq OWNED BY legacy.outcome_counts.id;


--
-- Name: outcome_measurements; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.outcome_measurements (
    id integer NOT NULL,
    nct_id character varying,
    outcome_id integer,
    result_group_id integer,
...
--
-- Name: outcome_measurements_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.outcome_measurements_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: outcome_measurements_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.outcome_measurements_id_seq OWNED BY legacy.outcome_measurements.id;


--
-- Name: outcomes; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.outcomes (
    id integer NOT NULL,
    nct_id character varying,
    outcome_type character varying,
    title text,
...
--
-- Name: outcomes_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.outcomes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: outcomes_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.outcomes_id_seq OWNED BY legacy.outcomes.id;


--
-- Name: overall_officials_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.overall_officials_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: overall_officials_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.overall_officials_id_seq OWNED BY legacy.overall_officials.id;


--
-- Name: participant_flows; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.participant_flows (
    id integer NOT NULL,
    nct_id character varying,
    recruitment_details text,
    pre_assignment_details text,
...
--
-- Name: participant_flows_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.participant_flows_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: participant_flows_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.participant_flows_id_seq OWNED BY legacy.participant_flows.id;


--
-- Name: pending_results; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.pending_results (
    id integer NOT NULL,
    nct_id character varying,
    event character varying,
    event_date_description character varying,
...
--
-- Name: pending_results_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.pending_results_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: pending_results_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.pending_results_id_seq OWNED BY legacy.pending_results.id;


--
-- Name: provided_documents; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.provided_documents (
    id integer NOT NULL,
    nct_id character varying,
    document_type character varying,
    has_protocol boolean,
...
--
-- Name: provided_documents_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.provided_documents_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: provided_documents_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.provided_documents_id_seq OWNED BY legacy.provided_documents.id;


--
-- Name: reported_event_totals; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.reported_event_totals (
    id integer NOT NULL,
    nct_id character varying NOT NULL,
    ctgov_group_code character varying NOT NULL,
    event_type character varying,
...
--
-- Name: reported_event_totals_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.reported_event_totals_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: reported_event_totals_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.reported_event_totals_id_seq OWNED BY legacy.reported_event_totals.id;


--
-- Name: reported_events; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.reported_events (
    id integer NOT NULL,
    nct_id character varying,
    result_group_id integer,
    ctgov_group_code character varying,
...
--
-- Name: reported_events_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.reported_events_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: reported_events_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.reported_events_id_seq OWNED BY legacy.reported_events.id;


--
-- Name: responsible_parties; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.responsible_parties (
    id integer NOT NULL,
    nct_id character varying,
    responsible_party_type character varying,
    name character varying,
...
--
-- Name: responsible_parties_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.responsible_parties_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: responsible_parties_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.responsible_parties_id_seq OWNED BY legacy.responsible_parties.id;


--
-- Name: result_agreements; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.result_agreements (
    id integer NOT NULL,
    nct_id character varying,
...
--
-- Name: result_agreements_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.result_agreements_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: result_agreements_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.result_agreements_id_seq OWNED BY legacy.result_agreements.id;


--
-- Name: result_contacts; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.result_contacts (
    id integer NOT NULL,
    nct_id character varying,
    organization character varying,
    name character varying,
...
--
-- Name: result_contacts_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.result_contacts_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: result_contacts_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.result_contacts_id_seq OWNED BY legacy.result_contacts.id;


--
-- Name: result_groups; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.result_groups (
    id integer NOT NULL,
    nct_id character varying,
    ctgov_group_code character varying,
    result_type character varying,
...
--
-- Name: result_groups_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.result_groups_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: result_groups_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.result_groups_id_seq OWNED BY legacy.result_groups.id;


--
-- Name: retractions; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.retractions (
    id bigint NOT NULL,
    reference_id integer,
    pmid character varying,
    source character varying,
...
--
-- Name: retractions_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.retractions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: retractions_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.retractions_id_seq OWNED BY legacy.retractions.id;


--
-- Name: search_results_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.search_results_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: search_results_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.search_results_id_seq OWNED BY legacy.search_results.id;


--
-- Name: sponsors_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.sponsors_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: sponsors_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.sponsors_id_seq OWNED BY legacy.sponsors.id;


--
-- Name: studies; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.studies (
    nct_id character varying,
    nlm_download_date_description character varying,
    study_first_submitted_date date,
    results_first_submitted_date date,
...
--
-- Name: study_records; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.study_records (
    id bigint NOT NULL,
    nct_id character varying,
    type character varying,
    content json,
...
--
-- Name: study_records_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.study_records_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: study_records_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.study_records_id_seq OWNED BY legacy.study_records.id;


--
-- Name: study_references; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.study_references (
    id integer NOT NULL,
    nct_id character varying,
    pmid character varying,
    reference_type character varying,
...
--
-- Name: study_references_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.study_references_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: study_references_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.study_references_id_seq OWNED BY legacy.study_references.id;


--
-- Name: study_searches; Type: TABLE; Schema: legacy; Owner: -
--

CREATE TABLE legacy.study_searches (
    id integer NOT NULL,
    save_tsv boolean DEFAULT false NOT NULL,
    query character varying NOT NULL,
    "grouping" character varying DEFAULT ''::character varying NOT NULL,
...
--
-- Name: study_searches_id_seq; Type: SEQUENCE; Schema: legacy; Owner: -
--

CREATE SEQUENCE legacy.study_searches_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: study_searches_id_seq; Type: SEQUENCE OWNED BY; Schema: legacy; Owner: -
--

ALTER SEQUENCE legacy.study_searches_id_seq OWNED BY legacy.study_searches.id;
...
--
-- Name: baseline_counts id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.baseline_counts ALTER COLUMN id SET DEFAULT nextval('legacy.baseline_counts_id_seq'::regclass);


--
-- Name: baseline_measurements id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.baseline_measurements ALTER COLUMN id SET DEFAULT nextval('legacy.baseline_measurements_id_seq'::regclass);


--
-- Name: brief_summaries id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.brief_summaries ALTER COLUMN id SET DEFAULT nextval('legacy.brief_summaries_id_seq'::regclass);


--
-- Name: browse_conditions id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.browse_conditions ALTER COLUMN id SET DEFAULT nextval('legacy.browse_conditions_id_seq'::regclass);


--
-- Name: browse_interventions id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.browse_interventions ALTER COLUMN id SET DEFAULT nextval('legacy.browse_interventions_id_seq'::regclass);


--
-- Name: calculated_values id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.calculated_values ALTER COLUMN id SET DEFAULT nextval('legacy.calculated_values_id_seq'::regclass);


--
-- Name: central_contacts id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.central_contacts ALTER COLUMN id SET DEFAULT nextval('legacy.central_contacts_id_seq'::regclass);


--
-- Name: conditions id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.conditions ALTER COLUMN id SET DEFAULT nextval('legacy.conditions_id_seq'::regclass);


--
-- Name: countries id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.countries ALTER COLUMN id SET DEFAULT nextval('legacy.countries_id_seq'::regclass);


--
-- Name: design_group_interventions id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.design_group_interventions ALTER COLUMN id SET DEFAULT nextval('legacy.design_group_interventions_id_seq'::regclass);


--
-- Name: design_groups id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.design_groups ALTER COLUMN id SET DEFAULT nextval('legacy.design_groups_id_seq'::regclass);


--
-- Name: design_outcomes id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.design_outcomes ALTER COLUMN id SET DEFAULT nextval('legacy.design_outcomes_id_seq'::regclass);


--
-- Name: designs id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.designs ALTER COLUMN id SET DEFAULT nextval('legacy.designs_id_seq'::regclass);


--
-- Name: detailed_descriptions id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.detailed_descriptions ALTER COLUMN id SET DEFAULT nextval('legacy.detailed_descriptions_id_seq'::regclass);


--
-- Name: documents id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.documents ALTER COLUMN id SET DEFAULT nextval('legacy.documents_id_seq'::regclass);


--
-- Name: drop_withdrawals id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.drop_withdrawals ALTER COLUMN id SET DEFAULT nextval('legacy.drop_withdrawals_id_seq'::regclass);


--
-- Name: eligibilities id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.eligibilities ALTER COLUMN id SET DEFAULT nextval('legacy.eligibilities_id_seq'::regclass);


--
-- Name: facilities id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.facilities ALTER COLUMN id SET DEFAULT nextval('legacy.facilities_id_seq'::regclass);


--
-- Name: facility_contacts id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.facility_contacts ALTER COLUMN id SET DEFAULT nextval('legacy.facility_contacts_id_seq'::regclass);


--
-- Name: facility_investigators id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.facility_investigators ALTER COLUMN id SET DEFAULT nextval('legacy.facility_investigators_id_seq'::regclass);


--
-- Name: id_information id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.id_information ALTER COLUMN id SET DEFAULT nextval('legacy.id_information_id_seq'::regclass);


--
-- Name: intervention_other_names id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.intervention_other_names ALTER COLUMN id SET DEFAULT nextval('legacy.intervention_other_names_id_seq'::regclass);


--
-- Name: interventions id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.interventions ALTER COLUMN id SET DEFAULT nextval('legacy.interventions_id_seq'::regclass);


--
-- Name: ipd_information_types id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.ipd_information_types ALTER COLUMN id SET DEFAULT nextval('legacy.ipd_information_types_id_seq'::regclass);


--
-- Name: keywords id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.keywords ALTER COLUMN id SET DEFAULT nextval('legacy.keywords_id_seq'::regclass);


--
-- Name: links id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.links ALTER COLUMN id SET DEFAULT nextval('legacy.links_id_seq'::regclass);


--
-- Name: mesh_headings id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.mesh_headings ALTER COLUMN id SET DEFAULT nextval('legacy.mesh_headings_id_seq'::regclass);


--
-- Name: mesh_terms id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.mesh_terms ALTER COLUMN id SET DEFAULT nextval('legacy.mesh_terms_id_seq'::regclass);


--
-- Name: milestones id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.milestones ALTER COLUMN id SET DEFAULT nextval('legacy.milestones_id_seq'::regclass);


--
-- Name: outcome_analyses id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.outcome_analyses ALTER COLUMN id SET DEFAULT nextval('legacy.outcome_analyses_id_seq'::regclass);


--
-- Name: outcome_analysis_groups id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.outcome_analysis_groups ALTER COLUMN id SET DEFAULT nextval('legacy.outcome_analysis_groups_id_seq'::regclass);


--
-- Name: outcome_counts id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.outcome_counts ALTER COLUMN id SET DEFAULT nextval('legacy.outcome_counts_id_seq'::regclass);


--
-- Name: outcome_measurements id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.outcome_measurements ALTER COLUMN id SET DEFAULT nextval('legacy.outcome_measurements_id_seq'::regclass);


--
-- Name: outcomes id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.outcomes ALTER COLUMN id SET DEFAULT nextval('legacy.outcomes_id_seq'::regclass);


--
-- Name: overall_officials id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.overall_officials ALTER COLUMN id SET DEFAULT nextval('legacy.overall_officials_id_seq'::regclass);


--
-- Name: participant_flows id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.participant_flows ALTER COLUMN id SET DEFAULT nextval('legacy.participant_flows_id_seq'::regclass);


--
-- Name: pending_results id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.pending_results ALTER COLUMN id SET DEFAULT nextval('legacy.pending_results_id_seq'::regclass);


--
-- Name: provided_documents id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.provided_documents ALTER COLUMN id SET DEFAULT nextval('legacy.provided_documents_id_seq'::regclass);


--
-- Name: reported_event_totals id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.reported_event_totals ALTER COLUMN id SET DEFAULT nextval('legacy.reported_event_totals_id_seq'::regclass);


--
-- Name: reported_events id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.reported_events ALTER COLUMN id SET DEFAULT nextval('legacy.reported_events_id_seq'::regclass);


--
-- Name: responsible_parties id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.responsible_parties ALTER COLUMN id SET DEFAULT nextval('legacy.responsible_parties_id_seq'::regclass);


--
-- Name: result_agreements id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.result_agreements ALTER COLUMN id SET DEFAULT nextval('legacy.result_agreements_id_seq'::regclass);


--
-- Name: result_contacts id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.result_contacts ALTER COLUMN id SET DEFAULT nextval('legacy.result_contacts_id_seq'::regclass);


--
-- Name: result_groups id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.result_groups ALTER COLUMN id SET DEFAULT nextval('legacy.result_groups_id_seq'::regclass);


--
-- Name: retractions id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.retractions ALTER COLUMN id SET DEFAULT nextval('legacy.retractions_id_seq'::regclass);


--
-- Name: search_results id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.search_results ALTER COLUMN id SET DEFAULT nextval('legacy.search_results_id_seq'::regclass);


--
-- Name: sponsors id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.sponsors ALTER COLUMN id SET DEFAULT nextval('legacy.sponsors_id_seq'::regclass);


--
-- Name: study_records id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.study_records ALTER COLUMN id SET DEFAULT nextval('legacy.study_records_id_seq'::regclass);


--
-- Name: study_references id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.study_references ALTER COLUMN id SET DEFAULT nextval('legacy.study_references_id_seq'::regclass);


--
-- Name: study_searches id; Type: DEFAULT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.study_searches ALTER COLUMN id SET DEFAULT nextval('legacy.study_searches_id_seq'::regclass);
...
--
-- Name: baseline_counts baseline_counts_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.baseline_counts
    ADD CONSTRAINT baseline_counts_pkey PRIMARY KEY (id);


--
-- Name: baseline_measurements baseline_measurements_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.baseline_measurements
    ADD CONSTRAINT baseline_measurements_pkey PRIMARY KEY (id);


--
-- Name: brief_summaries brief_summaries_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.brief_summaries
    ADD CONSTRAINT brief_summaries_pkey PRIMARY KEY (id);


--
-- Name: browse_conditions browse_conditions_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.browse_conditions
    ADD CONSTRAINT browse_conditions_pkey PRIMARY KEY (id);


--
-- Name: browse_interventions browse_interventions_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.browse_interventions
    ADD CONSTRAINT browse_interventions_pkey PRIMARY KEY (id);


--
-- Name: calculated_values calculated_values_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.calculated_values
    ADD CONSTRAINT calculated_values_pkey PRIMARY KEY (id);


--
-- Name: central_contacts central_contacts_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.central_contacts
    ADD CONSTRAINT central_contacts_pkey PRIMARY KEY (id);


--
-- Name: conditions conditions_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.conditions
    ADD CONSTRAINT conditions_pkey PRIMARY KEY (id);


--
-- Name: countries countries_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.countries
    ADD CONSTRAINT countries_pkey PRIMARY KEY (id);


--
-- Name: design_group_interventions design_group_interventions_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.design_group_interventions
    ADD CONSTRAINT design_group_interventions_pkey PRIMARY KEY (id);


--
-- Name: design_groups design_groups_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.design_groups
    ADD CONSTRAINT design_groups_pkey PRIMARY KEY (id);


--
-- Name: design_outcomes design_outcomes_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.design_outcomes
    ADD CONSTRAINT design_outcomes_pkey PRIMARY KEY (id);


--
-- Name: designs designs_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.designs
    ADD CONSTRAINT designs_pkey PRIMARY KEY (id);


--
-- Name: detailed_descriptions detailed_descriptions_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.detailed_descriptions
    ADD CONSTRAINT detailed_descriptions_pkey PRIMARY KEY (id);


--
-- Name: documents documents_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.documents
    ADD CONSTRAINT documents_pkey PRIMARY KEY (id);


--
-- Name: drop_withdrawals drop_withdrawals_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.drop_withdrawals
    ADD CONSTRAINT drop_withdrawals_pkey PRIMARY KEY (id);


--
-- Name: eligibilities eligibilities_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.eligibilities
    ADD CONSTRAINT eligibilities_pkey PRIMARY KEY (id);


--
-- Name: facilities facilities_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.facilities
    ADD CONSTRAINT facilities_pkey PRIMARY KEY (id);


--
-- Name: facility_contacts facility_contacts_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.facility_contacts
    ADD CONSTRAINT facility_contacts_pkey PRIMARY KEY (id);


--
-- Name: facility_investigators facility_investigators_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.facility_investigators
    ADD CONSTRAINT facility_investigators_pkey PRIMARY KEY (id);


--
-- Name: id_information id_information_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.id_information
    ADD CONSTRAINT id_information_pkey PRIMARY KEY (id);


--
-- Name: intervention_other_names intervention_other_names_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.intervention_other_names
    ADD CONSTRAINT intervention_other_names_pkey PRIMARY KEY (id);


--
-- Name: interventions interventions_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.interventions
    ADD CONSTRAINT interventions_pkey PRIMARY KEY (id);


--
-- Name: ipd_information_types ipd_information_types_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.ipd_information_types
    ADD CONSTRAINT ipd_information_types_pkey PRIMARY KEY (id);


--
-- Name: keywords keywords_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.keywords
    ADD CONSTRAINT keywords_pkey PRIMARY KEY (id);


--
-- Name: links links_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.links
    ADD CONSTRAINT links_pkey PRIMARY KEY (id);


--
-- Name: mesh_headings mesh_headings_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.mesh_headings
    ADD CONSTRAINT mesh_headings_pkey PRIMARY KEY (id);


--
-- Name: mesh_terms mesh_terms_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.mesh_terms
    ADD CONSTRAINT mesh_terms_pkey PRIMARY KEY (id);


--
-- Name: milestones milestones_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.milestones
    ADD CONSTRAINT milestones_pkey PRIMARY KEY (id);


--
-- Name: outcome_analyses outcome_analyses_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.outcome_analyses
    ADD CONSTRAINT outcome_analyses_pkey PRIMARY KEY (id);


--
-- Name: outcome_analysis_groups outcome_analysis_groups_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.outcome_analysis_groups
    ADD CONSTRAINT outcome_analysis_groups_pkey PRIMARY KEY (id);


--
-- Name: outcome_counts outcome_counts_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.outcome_counts
    ADD CONSTRAINT outcome_counts_pkey PRIMARY KEY (id);


--
-- Name: outcome_measurements outcome_measurements_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.outcome_measurements
    ADD CONSTRAINT outcome_measurements_pkey PRIMARY KEY (id);


--
-- Name: outcomes outcomes_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.outcomes
    ADD CONSTRAINT outcomes_pkey PRIMARY KEY (id);


--
-- Name: overall_officials overall_officials_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.overall_officials
    ADD CONSTRAINT overall_officials_pkey PRIMARY KEY (id);


--
-- Name: participant_flows participant_flows_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.participant_flows
    ADD CONSTRAINT participant_flows_pkey PRIMARY KEY (id);


--
-- Name: pending_results pending_results_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.pending_results
    ADD CONSTRAINT pending_results_pkey PRIMARY KEY (id);


--
-- Name: provided_documents provided_documents_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.provided_documents
    ADD CONSTRAINT provided_documents_pkey PRIMARY KEY (id);


--
-- Name: reported_event_totals reported_event_totals_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.reported_event_totals
    ADD CONSTRAINT reported_event_totals_pkey PRIMARY KEY (id);


--
-- Name: reported_events reported_events_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.reported_events
    ADD CONSTRAINT reported_events_pkey PRIMARY KEY (id);


--
-- Name: responsible_parties responsible_parties_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.responsible_parties
    ADD CONSTRAINT responsible_parties_pkey PRIMARY KEY (id);


--
-- Name: result_agreements result_agreements_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.result_agreements
    ADD CONSTRAINT result_agreements_pkey PRIMARY KEY (id);


--
-- Name: result_contacts result_contacts_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.result_contacts
    ADD CONSTRAINT result_contacts_pkey PRIMARY KEY (id);


--
-- Name: result_groups result_groups_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.result_groups
    ADD CONSTRAINT result_groups_pkey PRIMARY KEY (id);


--
-- Name: retractions retractions_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.retractions
    ADD CONSTRAINT retractions_pkey PRIMARY KEY (id);


--
-- Name: search_results search_results_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.search_results
    ADD CONSTRAINT search_results_pkey PRIMARY KEY (id);


--
-- Name: sponsors sponsors_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.sponsors
    ADD CONSTRAINT sponsors_pkey PRIMARY KEY (id);


--
-- Name: study_records study_records_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.study_records
    ADD CONSTRAINT study_records_pkey PRIMARY KEY (id);


--
-- Name: study_references study_references_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.study_references
    ADD CONSTRAINT study_references_pkey PRIMARY KEY (id);


--
-- Name: study_searches study_searches_pkey; Type: CONSTRAINT; Schema: legacy; Owner: -
--

ALTER TABLE ONLY legacy.study_searches
    ADD CONSTRAINT study_searches_pkey PRIMARY KEY (id);
...
--
-- Name: index_baseline_measurements_on_category; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_baseline_measurements_on_category ON legacy.baseline_measurements USING btree (category);


--
-- Name: index_baseline_measurements_on_classification; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_baseline_measurements_on_classification ON legacy.baseline_measurements USING btree (classification);


--
-- Name: index_baseline_measurements_on_dispersion_type; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_baseline_measurements_on_dispersion_type ON legacy.baseline_measurements USING btree (dispersion_type);


--
-- Name: index_baseline_measurements_on_param_type; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_baseline_measurements_on_param_type ON legacy.baseline_measurements USING btree (param_type);


--
-- Name: index_browse_conditions_on_downcase_mesh_term; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_browse_conditions_on_downcase_mesh_term ON legacy.browse_conditions USING btree (downcase_mesh_term);


--
-- Name: index_browse_conditions_on_mesh_term; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_browse_conditions_on_mesh_term ON legacy.browse_conditions USING btree (mesh_term);


--
-- Name: index_browse_conditions_on_nct_id; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_browse_conditions_on_nct_id ON legacy.browse_conditions USING btree (nct_id);


--
-- Name: index_browse_interventions_on_downcase_mesh_term; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_browse_interventions_on_downcase_mesh_term ON legacy.browse_interventions USING btree (downcase_mesh_term);


--
-- Name: index_browse_interventions_on_mesh_term; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_browse_interventions_on_mesh_term ON legacy.browse_interventions USING btree (mesh_term);


--
-- Name: index_browse_interventions_on_nct_id; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_browse_interventions_on_nct_id ON legacy.browse_interventions USING btree (nct_id);


--
-- Name: index_calculated_values_on_actual_duration; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_calculated_values_on_actual_duration ON legacy.calculated_values USING btree (actual_duration);


--
-- Name: index_calculated_values_on_months_to_report_results; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_calculated_values_on_months_to_report_results ON legacy.calculated_values USING btree (months_to_report_results);


--
-- Name: index_calculated_values_on_number_of_facilities; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_calculated_values_on_number_of_facilities ON legacy.calculated_values USING btree (number_of_facilities);


--
-- Name: index_central_contacts_on_contact_type; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_central_contacts_on_contact_type ON legacy.central_contacts USING btree (contact_type);


--
-- Name: index_conditions_on_downcase_name; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_conditions_on_downcase_name ON legacy.conditions USING btree (downcase_name);


--
-- Name: index_conditions_on_name; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_conditions_on_name ON legacy.conditions USING btree (name);


--
-- Name: index_design_group_interventions_on_design_group_id; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_design_group_interventions_on_design_group_id ON legacy.design_group_interventions USING btree (design_group_id);


--
-- Name: index_design_group_interventions_on_intervention_id; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_design_group_interventions_on_intervention_id ON legacy.design_group_interventions USING btree (intervention_id);


--
-- Name: index_design_groups_on_group_type; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_design_groups_on_group_type ON legacy.design_groups USING btree (group_type);


--
-- Name: index_design_outcomes_on_measure; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_design_outcomes_on_measure ON legacy.design_outcomes USING btree (measure);


--
-- Name: index_design_outcomes_on_outcome_type; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_design_outcomes_on_outcome_type ON legacy.design_outcomes USING btree (outcome_type);


--
-- Name: index_designs_on_caregiver_masked; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_designs_on_caregiver_masked ON legacy.designs USING btree (caregiver_masked);


--
-- Name: index_designs_on_investigator_masked; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_designs_on_investigator_masked ON legacy.designs USING btree (investigator_masked);


--
-- Name: index_designs_on_masking; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_designs_on_masking ON legacy.designs USING btree (masking);


--
-- Name: index_designs_on_outcomes_assessor_masked; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_designs_on_outcomes_assessor_masked ON legacy.designs USING btree (outcomes_assessor_masked);


--
-- Name: index_designs_on_subject_masked; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_designs_on_subject_masked ON legacy.designs USING btree (subject_masked);


--
-- Name: index_documents_on_document_id; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_documents_on_document_id ON legacy.documents USING btree (document_id);


--
-- Name: index_documents_on_document_type; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_documents_on_document_type ON legacy.documents USING btree (document_type);


--
-- Name: index_drop_withdrawals_on_period; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_drop_withdrawals_on_period ON legacy.drop_withdrawals USING btree (period);


--
-- Name: index_eligibilities_on_gender; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_eligibilities_on_gender ON legacy.eligibilities USING btree (gender);


--
-- Name: index_eligibilities_on_healthy_volunteers; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_eligibilities_on_healthy_volunteers ON legacy.eligibilities USING btree (healthy_volunteers);


--
-- Name: index_eligibilities_on_maximum_age; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_eligibilities_on_maximum_age ON legacy.eligibilities USING btree (maximum_age);


--
-- Name: index_eligibilities_on_minimum_age; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_eligibilities_on_minimum_age ON legacy.eligibilities USING btree (minimum_age);


--
-- Name: index_facilities_on_city; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_facilities_on_city ON legacy.facilities USING btree (city);


--
-- Name: index_facilities_on_country; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_facilities_on_country ON legacy.facilities USING btree (country);


--
-- Name: index_facilities_on_name; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_facilities_on_name ON legacy.facilities USING btree (name);


--
-- Name: index_facilities_on_state; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_facilities_on_state ON legacy.facilities USING btree (state);


--
-- Name: index_facilities_on_status; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_facilities_on_status ON legacy.facilities USING btree (status);


--
-- Name: index_facility_contacts_on_contact_type; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_facility_contacts_on_contact_type ON legacy.facility_contacts USING btree (contact_type);


--
-- Name: index_id_information_on_id_source; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_id_information_on_id_source ON legacy.id_information USING btree (id_source);


--
-- Name: index_interventions_on_intervention_type; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_interventions_on_intervention_type ON legacy.interventions USING btree (intervention_type);


--
-- Name: index_keywords_on_downcase_name; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_keywords_on_downcase_name ON legacy.keywords USING btree (downcase_name);


--
-- Name: index_keywords_on_name; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_keywords_on_name ON legacy.keywords USING btree (name);


--
-- Name: index_mesh_headings_on_qualifier; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_mesh_headings_on_qualifier ON legacy.mesh_headings USING btree (qualifier);


--
-- Name: index_mesh_terms_on_description; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_mesh_terms_on_description ON legacy.mesh_terms USING btree (description);


--
-- Name: index_mesh_terms_on_downcase_mesh_term; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_mesh_terms_on_downcase_mesh_term ON legacy.mesh_terms USING btree (downcase_mesh_term);


--
-- Name: index_mesh_terms_on_mesh_term; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_mesh_terms_on_mesh_term ON legacy.mesh_terms USING btree (mesh_term);


--
-- Name: index_mesh_terms_on_qualifier; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_mesh_terms_on_qualifier ON legacy.mesh_terms USING btree (qualifier);


--
-- Name: index_milestones_on_period; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_milestones_on_period ON legacy.milestones USING btree (period);


--
-- Name: index_outcome_analyses_on_dispersion_type; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_outcome_analyses_on_dispersion_type ON legacy.outcome_analyses USING btree (dispersion_type);


--
-- Name: index_outcome_analyses_on_param_type; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_outcome_analyses_on_param_type ON legacy.outcome_analyses USING btree (param_type);


--
-- Name: index_outcome_measurements_on_category; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_outcome_measurements_on_category ON legacy.outcome_measurements USING btree (category);


--
-- Name: index_outcome_measurements_on_classification; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_outcome_measurements_on_classification ON legacy.outcome_measurements USING btree (classification);


--
-- Name: index_outcome_measurements_on_dispersion_type; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_outcome_measurements_on_dispersion_type ON legacy.outcome_measurements USING btree (dispersion_type);


--
-- Name: index_outcomes_on_dispersion_type; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_outcomes_on_dispersion_type ON legacy.outcomes USING btree (dispersion_type);


--
-- Name: index_outcomes_on_param_type; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_outcomes_on_param_type ON legacy.outcomes USING btree (param_type);


--
-- Name: index_overall_officials_on_affiliation; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_overall_officials_on_affiliation ON legacy.overall_officials USING btree (affiliation);


--
-- Name: index_overall_officials_on_nct_id; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_overall_officials_on_nct_id ON legacy.overall_officials USING btree (nct_id);


--
-- Name: index_reported_events_on_event_type; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_reported_events_on_event_type ON legacy.reported_events USING btree (event_type);


--
-- Name: index_reported_events_on_subjects_affected; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_reported_events_on_subjects_affected ON legacy.reported_events USING btree (subjects_affected);


--
-- Name: index_responsible_parties_on_nct_id; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_responsible_parties_on_nct_id ON legacy.responsible_parties USING btree (nct_id);


--
-- Name: index_responsible_parties_on_organization; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_responsible_parties_on_organization ON legacy.responsible_parties USING btree (organization);


--
-- Name: index_responsible_parties_on_responsible_party_type; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_responsible_parties_on_responsible_party_type ON legacy.responsible_parties USING btree (responsible_party_type);


--
-- Name: index_result_contacts_on_organization; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_result_contacts_on_organization ON legacy.result_contacts USING btree (organization);


--
-- Name: index_result_groups_on_result_type; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_result_groups_on_result_type ON legacy.result_groups USING btree (result_type);


--
-- Name: index_search_results_on_nct_id_and_name; Type: INDEX; Schema: legacy; Owner: -
--

CREATE UNIQUE INDEX index_search_results_on_nct_id_and_name ON legacy.search_results USING btree (nct_id, name);


--
-- Name: index_search_results_on_nct_id_and_name_and_grouping; Type: INDEX; Schema: legacy; Owner: -
--

CREATE UNIQUE INDEX index_search_results_on_nct_id_and_name_and_grouping ON legacy.search_results USING btree (nct_id, name, "grouping");


--
-- Name: index_sponsors_on_agency_class; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_sponsors_on_agency_class ON legacy.sponsors USING btree (agency_class);


--
-- Name: index_sponsors_on_name; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_sponsors_on_name ON legacy.sponsors USING btree (name);


--
-- Name: index_studies_on_completion_date; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_studies_on_completion_date ON legacy.studies USING btree (completion_date);


--
-- Name: index_studies_on_disposition_first_submitted_date; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_studies_on_disposition_first_submitted_date ON legacy.studies USING btree (disposition_first_submitted_date);


--
-- Name: index_studies_on_enrollment_type; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_studies_on_enrollment_type ON legacy.studies USING btree (enrollment_type);


--
-- Name: index_studies_on_last_known_status; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_studies_on_last_known_status ON legacy.studies USING btree (last_known_status);


--
-- Name: index_studies_on_last_update_submitted_date; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_studies_on_last_update_submitted_date ON legacy.studies USING btree (last_update_submitted_date);


--
-- Name: index_studies_on_nct_id; Type: INDEX; Schema: legacy; Owner: -
--

CREATE UNIQUE INDEX index_studies_on_nct_id ON legacy.studies USING btree (nct_id);


--
-- Name: index_studies_on_overall_status; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_studies_on_overall_status ON legacy.studies USING btree (overall_status);


--
-- Name: index_studies_on_phase; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_studies_on_phase ON legacy.studies USING btree (phase);


--
-- Name: index_studies_on_primary_completion_date; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_studies_on_primary_completion_date ON legacy.studies USING btree (primary_completion_date);


--
-- Name: index_studies_on_primary_completion_date_type; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_studies_on_primary_completion_date_type ON legacy.studies USING btree (primary_completion_date_type);


--
-- Name: index_studies_on_results_first_submitted_date; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_studies_on_results_first_submitted_date ON legacy.studies USING btree (results_first_submitted_date);


--
-- Name: index_studies_on_source; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_studies_on_source ON legacy.studies USING btree (source);


--
-- Name: index_studies_on_start_date; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_studies_on_start_date ON legacy.studies USING btree (start_date);


--
-- Name: index_studies_on_start_date_type; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_studies_on_start_date_type ON legacy.studies USING btree (start_date_type);


--
-- Name: index_studies_on_study_first_submitted_date; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_studies_on_study_first_submitted_date ON legacy.studies USING btree (study_first_submitted_date);


--
-- Name: index_studies_on_study_type; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_studies_on_study_type ON legacy.studies USING btree (study_type);


--
-- Name: index_study_records_on_nct_id_and_type; Type: INDEX; Schema: legacy; Owner: -
--

CREATE UNIQUE INDEX index_study_records_on_nct_id_and_type ON legacy.study_records USING btree (nct_id, type);


--
-- Name: index_study_references_on_reference_type; Type: INDEX; Schema: legacy; Owner: -
--

CREATE INDEX index_study_references_on_reference_type ON legacy.study_references USING btree (reference_type);


--
-- Name: index_study_searches_on_query_and_grouping; Type: INDEX; Schema: legacy; Owner: -
--

CREATE UNIQUE INDEX index_study_searches_on_query_and_grouping ON legacy.study_searches USING btree (query, "grouping");
...
--
-- Name: categories category_insert_trigger; Type: TRIGGER; Schema: legacy; Owner: -
--

CREATE TRIGGER category_insert_trigger INSTEAD OF INSERT ON legacy.categories FOR EACH ROW EXECUTE FUNCTION legacy.category_insert_function();
