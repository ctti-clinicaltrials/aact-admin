class PagesController < ApplicationController
  ...
  def set_daily_monthly_snapshot_files
    ...
    @beta_daily_files=fpm.beta_daily_snapshot_files
    @beta_archive_files=fpm.beta_monthly_snapshot_files
  end
  ...
  def set_daily_monthly_pipe_files
    ...
    @beta_daily_files=fpm.beta_daily_flat_files
    @beta_archive_files=fpm.beta_monthly_flat_files
  end
