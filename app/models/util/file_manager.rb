...
module Util
  class FileManager
    def initialize
      ...
      FileUtils.mkdir_p "#{RootDir}/archive_static_db_copies/daily"
      FileUtils.mkdir_p "#{RootDir}/archive_static_db_copies/monthly"
      FileUtils.mkdir_p "#{RootDir}/exported_files/daily"
      FileUtils.mkdir_p "#{RootDir}/exported_files/monthly"
      FileUtils.mkdir_p "#{RootDir}/archive_exported_files/daily"
      FileUtils.mkdir_p "#{RootDir}/archive_exported_files/monthly"
